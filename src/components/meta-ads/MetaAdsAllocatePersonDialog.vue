<template>
  <el-dialog
    ...
    title="分配投手"
    width="480px"
    class="meta-ads-allocate-person-dialog"
  ...
  >
    <div class="meta-ads-allocate-person-dialog__summary">
      已选择 <strong>{{ campaigns.length }}</strong> 个广告系列
    </div>

    <el-form label-position="top" class="meta-ads-allocate-person-form">
    ...
    <template #footer>
      <div class="meta-ads-allocate-person-dialog__footer">
